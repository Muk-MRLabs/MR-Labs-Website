          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="mb-6 text-xl">
                Every business is different. We don't use cookie-cutter solutions.
                Here's how we tackle your unique challenges:
              </p>
            ...
            <div className="bg-background rounded-lg p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-lg">Cut costs by up to 40%</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-6 w-6 text-mrblue-400 mr-3 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-lg">Get more done in less time</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-6 w-6 text-mrblue-400 mr-3 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-lg">Free up your team for important stuff</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-6 w-6 text-mrblue-400 mr-3 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-lg">Make customers happier with faster service</span>
                </li>
                <li className="flex items-start">
                  <svg className="h-6 w-6 text-mrblue-400 mr-3 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
